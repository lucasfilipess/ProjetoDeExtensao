...
import { Container, Banner, Content,Buttons, BannerSec, Boxes } from './styles.module.scss';
function WebPage() {
  return (
    <>
      <div className={Container}>
        ...
        <div className={BannerSec} style={{ backgroundImage: `url(${SecondBanner})` }} >
        <div className={Boxes}>
          <div>
            <h2>Endereço</h2>
            {/* <img src={calendarSvg} alt="calendar" /> */}
            <p>A clínica fica localizada na 
              Av. Professor Mário Werneck, 1685 - Buritis, Belo Horizonte - MG, 30575-180</p>
          </div>
          <div>
